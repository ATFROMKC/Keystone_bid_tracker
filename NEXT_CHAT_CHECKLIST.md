...
1. Tell the agent to read: `AGENTS.md`, `PROJECT_CONTEXT.md`, `SESSION_NOTES.md`, `OTHER_PC_HANDOFF.md`, `NEXT_CHAT_CHECKLIST.md`, `.cursor/rules/context-first.mdc`, `.cursor/rules/git-session-sync.mdc`.
...
Before we start, read `AGENTS.md`, `PROJECT_CONTEXT.md`, `SESSION_NOTES.md`, `OTHER_PC_HANDOFF.md`, and `NEXT_CHAT_CHECKLIST.md` in the repo root, plus `.cursor/rules/context-first.mdc` and `.cursor/rules/git-session-sync.mdc`. Then give me:
